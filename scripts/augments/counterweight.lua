...
function apply(input)
	...
	if not output:instanceValue("usesCounterweightUpgrades") then return nil end

	if output:instanceValue("counterWeightType") == config.getParameter("itemName") then return nil end
